...
\label{chap:results}
\initial{T}he Following implementation have been done on Ubuntu Linux and our objective is to implement the framework in a Linux environment and then port it to Android.
...
\begin{figure}[h]
   ...
   \includegraphics[width=12cm]{fig05/mega1}
   \caption{Megafuse.h defining supported  Fuse File Operations}
    \includegraphics[width=12cm]{fig05/mega2}
...
\begin{figure}[h]
   ...
   \includegraphics[width=15cm]{fig05/mega4}
   \caption{Running Megafuse Client}
   \includegraphics[width=15cm]{fig05/mega3}
...
\begin{figure}[h]
   ...
   \bigskip
   \includegraphics[width=12cm]{fig05/sleuthkit}
...
\textbf{Recovered Images}\\
 \bigskip
  \includegraphics[width=12cm]{fig05/exitmetadata}
...
\textbf{Recovered Email Id's}\\
    \bigskip
       ...
       \includegraphics[width=12cm]{fig05/emails}
...
\textbf{Hiding Filesystems using Rootkits}\\
    \bigskip
       ...
       \includegraphics[width=12cm]{fig05/rooty}
